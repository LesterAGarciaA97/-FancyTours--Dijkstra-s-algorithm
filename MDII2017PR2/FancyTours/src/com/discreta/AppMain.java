...
public class AppMain extends javax.swing.JFrame {
    ...
    public AppMain() {
        initComponents();
        instrucciones.setText("Travel Calculator es una aplicación que nace de la necesidad de brindar a los clientes la mejor alternativa posible en términos de costo, en esta aplicación se ingresan las ciudades que el usuario desea visitar, el precio del boleto entre las ciudades indicadas y por último le devuelve cual sería la mejor ruta.\n"
                ...
                + "Para calcular el camino más corto, hacer click Derecho en el nodo origen y click derecho en el nodo final.");
    ...
    private void initComponents() {
        ...
        jPanel1.getAccessibleContext().setAccessibleName("Fancy Tours");
        ...
        jPanelPrincipal.getAccessibleContext().setAccessibleName("Fancy Tours");
    ...
    private int ingresarPeso() {
        String peso = JOptionPane.showInputDialog("Longitud de la Arista");
        int intPeso = 0;
        try {
